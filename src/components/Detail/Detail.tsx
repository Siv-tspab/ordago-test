...
export default function Detail({ user }: { user: User | undefined }) {
    return user ? (
        <div className="fixed right-0 w-2/5 mx-5 mt-5 h-max bg-no-repeat bg-cover bg-center rounded-xl" style={{ backgroundImage: `url(${user?.picture.large})` }}>
            <div className="rounded-lg p-10 font-semibold text-lg bg-slate-900/80">
                ...
                <div className="flex items-center pb-2">
                    ...
                    <Button label={["Add", <span className="pl-2"><AddIcon /></span>]}/>
                </div>
